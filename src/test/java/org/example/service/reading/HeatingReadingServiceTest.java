...
public class HeatingReadingServiceTest {

    private HeatingReadingService readingService;
    private User user1;
    private User user2;
    private HeatingReadingDto dto1;
    private HeatingReadingDto dto2;
    private HeatingReadingDto dto3;
    private List<HeatingReadingDto> expect;

    @BeforeEach
    public void setUp() {
        readingService = new HeatingReadingService();
        user1 = User.builder()
                .firstName("Алекс")
                .lastName("Иванов")
