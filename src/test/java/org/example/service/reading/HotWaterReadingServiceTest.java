...
public class HotWaterReadingServiceTest {

    private HotWaterReadingService readingService;
    private User user1;
    private User user2;
    private HotWaterReadingDto dto1;
    private HotWaterReadingDto dto2;
    private HotWaterReadingDto dto3;
    private List<HotWaterReadingDto> expect;


    @BeforeEach
    public void setUp() {
        readingService = new HotWaterReadingService();
        user1 = User.builder()
                .firstName("Алекс")
                .lastName("Иванов")
